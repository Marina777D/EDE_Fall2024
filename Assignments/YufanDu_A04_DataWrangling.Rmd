...
#1c Read in the four datasets, setting string columns as factors
epa_o3_2018 <- read_csv(here("Data","Raw","EPAair_O3_NC2018_raw.csv"), col_types = cols(.default = "f"))
epa_o3_2019 <- read_csv(here("Data","Raw","EPAair_O3_NC2019_raw.csv"), col_types = cols(.default = "f"))
epa_pm25_2018 <- read_csv(here("Data","Raw","EPAair_PM25_NC2018_raw.csv"), col_types = cols(.default = "f"))
epa_pm25_2019 <- read_csv(here("Data","Raw","EPAair_PM25_NC2019_raw.csv"), col_types = cols(.default = "f"))
...
#3 Convert the Date column to Date type using lubridate
...
epafiles = list.files(path = "./Data/Processed/EPA/",pattern = "*.csv", full.names = TRUE)
epafiles
